...
You can also deploy your app to BG IPFS by running:
...
Below is an example of the output you'll see:

```
🚀 Upload complete! Your site is now available at: https://community.bgipfs.com/ipfs/bafybeicrhakhu4bkzyuuaprtie4dkup6wpiplndnsisd2gzv4uzayurvem
```

And that is all!
If you want to use your ENS name as a gateway(e.g. `your-ens-name.eth.limo` will point to your app), you can check the following [guide](https://eth-limo.gitbook.io/documentation/beginner/configuring-your-ens-name/updating-your-ens-content-records).
