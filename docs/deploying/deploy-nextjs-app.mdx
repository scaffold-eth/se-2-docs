...
- **Build Command:** `yarn generate && yarn build`  
- **Output Directory:** `.next`

**Notes**  
- `NEXT_PUBLIC_*` vars are injected at **build** time; redeploy after changes.  
- Contract addresses are read from `packages/nextjs/generated/deployedContracts.ts` (created by `yarn generate`).
:::
