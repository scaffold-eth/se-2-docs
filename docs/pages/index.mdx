...
<HomePage.Root>
  <HomePage.Logo />
  <HomePage.Tagline>🏗 Scaffold-ETH 2</HomePage.Tagline>
  <HomePage.InstallPackage name="create-eth" type="init" />
  <HomePage.Description>
    Everything you need to get started building decentralized applications on
    Ethereum! 🚀 Built using NextJS, RainbowKit, Hardhat, Foundry, Wagmi, and
    TypeScript.
  </HomePage.Description>
  <HomePage.Buttons>
    <HomePage.Button href="/quick-start/installation" variant="accent">
      Get started
    </HomePage.Button>
    <HomePage.Button href="https://github.com/scaffold-eth/scaffold-eth-2">
      GitHub
    </HomePage.Button>
  </HomePage.Buttons>
</HomePage.Root>
