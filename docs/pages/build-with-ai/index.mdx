...
Scaffold-ETH 2 is built for AI coding agents like [Claude Code](https://claude.ai/code), [Cursor](https://cursor.sh), [Cline](https://github.com/cline/cline), and others.
