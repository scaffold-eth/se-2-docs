...
Initialize the [useScaffoldContractRead](/hooks/scaffold-eth#usescaffoldcontractread) hook to read from contract. This hook provides the `data` which contains the return value of the function.
